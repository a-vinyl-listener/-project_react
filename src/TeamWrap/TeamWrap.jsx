...
import './TeamWrap.scss';


export const TeamWrap = () => {
  return (
    <>
      {/* <!-- team --> */}

      <section className="team  team-wrapper">
        <div className="container">
          ...
          <div className="team__wrap">
            ...
            <div className="team__flashcards">
              ...
              <div className="team__inner">
                <h2 className="team__initials">Riga Pelore</h2>
                <div className="team__footer">
                  <p className="team__position">Farmer</p>
                  <div className="team__icon">
                    <a href="https://www.instagram.com">
            ...
            <div className="team__flashcards">
              <div className="team__image">
                <img className="team__img" src="../../public/09/04.webp" alt="#" />
              </div>
              <div className="team__inner">
                <h2 className="team__initials">Keira Knightle</h2>
                <div className="team__footer">
                  <p className="team__position">Farmer</p>
                  <div className="team__icon">
                    <a href="https://www.facebook.com">
            ...
            <div className="team__flashcards">
              <div className="team__image">
                <img className="team__img" src="../../public/09/05.webp" alt="#" />
              </div>
              <div className="team__inner">
                <h2 className="team__initials">Scott Lawrence</h2>
                <div className="team__footer">
            ...
            <div className="team__flashcards">
              <div className="team__image">
                <img className="team__img" src="../../public/09/06.webp" alt="#" />
              </div>
              <div className="team__inner">
                <h2 className="team__initials">Karen Allen</h2>
                <div className="team__footer">
                  <p className="team__position">Farmer</p>
                  <div className="team__icon">
                    <a href="https://www.instagram.com">
